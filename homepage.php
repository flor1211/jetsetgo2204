    ...
    <footer class="footer">
      <div class="footer-container">
        <div class="footer-brand">
          <img src="assets/logo.webp" alt="JetSetGo Logo" class="footer-logo" />
          <div class="brand-text">
            <h3>JetSetGo</h3>
            <p>Making travel simple, fast, and enjoyable for everyone.</p>
          </div>
        </div>
        ...
        <div class="footer-grid">
          ...
          <div class="footer-section newsletter-section">
            <h2 class="newsletter-title">Your<br>Journey<br>Starts Here</h2>
            <p class="newsletter-desc">Get up to date with the latest bookings and deals from us.</p>
            <form class="newsletter-form" action="#" method="post" autocomplete="off">
              <input type="email" class="newsletter-input" placeholder="Enter your email" required />
              <button type="submit" class="newsletter-btn">
                Subscribe to our Newsletter <span class="newsletter-arrow">&rarr;</span>
              </button>
            </form>
          </div>
        </div>
