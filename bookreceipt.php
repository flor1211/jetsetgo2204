...
$_SESSION['selected_depflight'];
$_SESSION['selected_retflight'];

$_SESSION['depfligtInfo'];
$_SESSION['retfligtInfo'];

$_SESSION['guest_details'];

$_SESSION['numberofpassenger'];
$_SESSION['departing_price'];
$_SESSION['returning_price'];
$_SESSION['total_price'];
$_SESSION['payment'];
$_SESSION['onsite_name'];
$_SESSION['onsite_idnum'];
