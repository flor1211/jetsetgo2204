    ...
    <div style="margin-left: 225px; padding: 20px;">
      ...
      <section class="p-3">
        <div class="col-8">
          ...
          <button class="btn btn-prim" data-bs-toggle="modal" data-bs-target="#userForm">
            ...
            <table class="table table-striped table-hover mt-3 text-center table-bordered">
              ...
              <tbody id="data">
                <tr>
                  ...
                  <td>Pending</td>
                  <td>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#readData">VIEW<i class="bi bi-eye"></i></button>
